...
public class ParkingLotTests {
    ...
    @Test
    public void reserveSlotWithAlreadyExistingCar_shouldThrowError() {
        ParkingLot parkingLot = new ParkingLot(2);
        Car car = new Car("TN02BH1145", "Red");
        parkingLot.reserveSlot(car);

        Car car2 = new Car("TN02BH1145", "Red");
        assertThrows(
    ...
    @Test
    public void leaveSlot_whenSlotIsNotOccupied() {
        ParkingLot parkingLot = new ParkingLot(6);
        assertThrows(
                InvalidLeaveSlotException.class,
    ...
    @Test
    public void getRegistrationNumbersByColor_shouldReturnEmptyList(){
        ParkingLot parkingLot = new ParkingLot(10);
        ...
        assertEquals(registrationNumbers.size(),0);
    }
    ...
    @Test
    public void getSlotNumbersByColor_shouldReturnEmptyList() {
        ParkingLot parkingLot = new ParkingLot(10);
        ...
        List<Integer> slotNumbers = parkingLot.getSlotNumbersByColor("Black");

        assertEquals(slotNumbers.size(), 0);
    }
