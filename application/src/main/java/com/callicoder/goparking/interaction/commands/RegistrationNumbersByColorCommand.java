...
public class RegistrationNumbersByColorCommand implements Command {
    ...
    public RegistrationNumbersByColorCommand(ParkingLotCommandHandler parkingLotCommandHandler) {
    ...
    public void execute(String[] params) throws InvalidParameterException {
        ...
        this.parkingLotCommandHandler.getRegistrationNumbersByColor(params[0]);
    }
}
