...
public class SlotNumberByRegistrationNumberCommand implements Command {
    ...
    public SlotNumberByRegistrationNumberCommand(ParkingLotCommandHandler parkingLotCommandHandler) {
    ...
    public void execute(String[] params) throws InvalidParameterException {
        ...
        this.parkingLotCommandHandler.getSlotNumberForRegistrationNumber(params[0]);
    }
}
