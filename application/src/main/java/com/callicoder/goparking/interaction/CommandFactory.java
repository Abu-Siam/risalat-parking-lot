...
public class CommandFactory {
    ...
    public static CommandFactory init(
        ...
        cf.addCommand("registration_numbers_for_cars_with_colour", new RegistrationNumbersByColorCommand(parkingLotCommandHandler));
        cf.addCommand("slot_numbers_for_cars_with_colour", new SlotNumbersByColorCommand(parkingLotCommandHandler));
        cf.addCommand("slot_number_for_registration_number", new SlotNumberByRegistrationNumberCommand(parkingLotCommandHandler));
